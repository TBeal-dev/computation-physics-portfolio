...
to setup-food  ;; patch procedure
  ...
  if (distancexy (.6 * max-pxcor) 0) < 5
  [ set food-source-number 1 ]
  ;; setup food source two on the lower-left
  if (distancexy (-.6 * max-pxcor) (-.6 * max-pycor)) < 5
  [ set food-source-number 2 ]
  ;; setup food source three on the upper-left
  if (distancexy (-.4 * max-pxcor) (.4 * max-pycor)) < 5
  [ set food-source-number 3 ]
  if (distancexy (-.8 * max-pxcor) (.8 * max-pycor)) < 5
  [ set food-source-number 4 ]
  if (distancexy (-.2 * max-pxcor) (-.2 * max-pycor)) < 5
...
to recolor-patch  ;; patch procedure
  ...
  [ ifelse food > 0
    [ if food-source-number = 1 [ set pcolor cyan ]
      ...
      if food-source-number = 4 [ set pcolor white ]
      if food-source-number = 5 [ set pcolor red ]
      if food-source-number = 6 [ set pcolor yellow ]]
...
"food-in-pile4" 1.0 0 -7500403 true "" "plotxy ticks sum [food] of patches with [pcolor = yellow]"
"food-in-pile5" 1.0 0 -2674135 true "" "plotxy ticks sum [food] of patches with [pcolor = red]"
"food-in-pile6" 1.0 0 -955883 true "" "plotxy ticks sum [food] of patches with [pcolor = white]"
